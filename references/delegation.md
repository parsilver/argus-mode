...
| A completed diff to sweep for simplification — reuse, dedup, dead weight | `simplify` or a code-simplifier skill |
...
(`quality.md`, principle 4), applied deliberately rather than in
passing — the minimum bar either
way.
